...
namespace MATO.NET
{
    public class EmailerService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            SmtpClient client = new SmtpClient
            {
                ...
                Host = ConfigurationManager.AppSettings["MATOEmailHost"]
            };

            var mail = ConfigurationManager.AppSettings["MATOEmailAddress"];
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<MATOContext>()));
